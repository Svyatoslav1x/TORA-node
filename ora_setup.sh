...
# read -p "Enter your WSS URL for Ethereum Sepoila: " SEPOILA_WSS
# read -p "Enter your HTTP URL for Ethereum Sepoila: " SEPOILA_HTTP
...
# SEPOLIA_WSS="$SEPOILA_WSS"
# SEPOLIA_HTTP="$SEPOILA_HTTP"
